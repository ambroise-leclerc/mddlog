function(enable_sanitizers project_name)
  ...
  if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU" OR CMAKE_CXX_COMPILER_ID MATCHES ".*Clang")
    ...
    if(ENABLE_SANITIZER_THREAD)
      if("address" IN_LIST SANITIZERS OR "leak" IN_LIST SANITIZERS)
        message(FATAL_ERROR "Thread sanitizer cannot be combined with Address or Leak sanitizer")
      endif()
  ...
  if(LIST_OF_SANITIZERS)
    if(NOT
      ...
      # in CI means a job that reports the violation and then passes. Aborting turns a recoverable
      # sanitizer finding into an actual failure.
