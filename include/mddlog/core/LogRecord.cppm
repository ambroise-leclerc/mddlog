...
export namespace mddlog::core {
    ...
    struct LogRecord {
         ...
         */
        void setAuditInfo(std::string_view eventType, 
                         std::string_view riskLvl = "",
                         std::string_view standard = "IEC_62304") {
    ...
    struct LogStatistics {
        ...
        std::chrono::nanoseconds getAverageWriteTime() const noexcept {
            ...
            if (records == 0) return std::chrono::nanoseconds{0};
