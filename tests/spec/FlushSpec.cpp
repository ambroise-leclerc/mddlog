...
const speclab::Register flushWaitsForAcceptedRecords{"flush() returns only after every previously accepted record was delivered", "unit", [] {
                                                         struct State {
...
const speclab::Register flushIsABarrierNotADrainSkip{"A second flush() after more records still waits for those too", "unit", [] {
                                                         struct State {
...
const speclab::Register destructionDrainsAcceptedRecords{"Destroying the logger drains records already accepted into its queue", "unit", [] {
                                                             struct State {
                                                                 std::shared_ptr<RecordingSink> sink = std::make_shared<RecordingSink>();
                                                             };
